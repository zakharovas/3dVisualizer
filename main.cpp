...
//    drawer.Draw();
    ...
    Camera cameravv(Point(-100, 0, 200), Point(100, 0, 200), Point(-100, 0, 0), Point(100, 0, 0), Point(0, -300, 100));
    Camera cam(Point(-50, 0, 50), Point(50, 0, 50), Point(-50, 0, -30), Point(50, 0, -30), Point(0, 100, 20));
    World perfect_world = reader.CreateWorld();
    perfect_world.SetCamera(cam);
...
//    perfect_world.AddPrimitive(triangle4);
    LightSource light(Point(0, 100, 20), 5000.5);
//
...
//    perfect_world.AddPrimitive(sphere);
    ...
    Image image = perfect_world.CreateImageWithAntialiasing(height, width);
    Drawer drawer(image);
    drawer.Draw();
    return 0;
}